...
describe("AccessControl", () => {
    ...
    it("should strictly match command with anchored regex", async () => {
        const policies: Policy[] = [
            {
                type: "grant",
                toolName: ["exec"],
                sessionKey: ["*"],
                condition: "params.command match '^(ls|pwd)$'",
                desc: "Strict whitelist for ls and pwd"
            }
        ];
